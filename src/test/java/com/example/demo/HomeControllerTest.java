...
public class HomeControllerTest {
    ...
    void indexPageHasSeveralHtmlForms() throws Exception{
        ...
        assertThat(html).contains(
                ...
                "<form method=\"post\" action=\"/multi-field-search\">",
                "<form method=\"post\" action=\"/universal-search\">",
                "<form method=\"post\" action=\"/delete/videos/1\">"
        );
    }
    ...
    void postNewVideoShouldWork() throws Exception{
        ...
        verify(videoService).create(
                new NewVideo("Test Video", "Test Description"),"user"
        );
    }
}
